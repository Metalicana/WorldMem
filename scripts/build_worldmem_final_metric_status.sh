...
LPIPS_SUMMARY="${LPIPS_SUMMARY:-$METRICS_ROOT/lpips_budget_sweep_60s_n15/summary.csv}"
FVD_SUMMARY="${FVD_SUMMARY:-$METRICS_ROOT/fvd_budget_sweep_60s_n15/summary.csv}"
VBENCH_ROOT="${VBENCH_RESULTS_ROOT:-$METRICS_ROOT/vbench_budget_sweep_60s_n15}"
VBENCH_LONG_ROOT="${VBENCH_LONG_RESULTS_ROOT:-$METRICS_ROOT/vbench_long_budget_sweep_60s_n15}"
