...
SLAM_GEOMETRY_WEIGHT="${SLAM_GEOMETRY_WEIGHT:-0.65}"
SLAM_VISUAL_WEIGHT="${SLAM_VISUAL_WEIGHT:-0.35}"
MEMORY_PRIORITY_UPDATE="${MEMORY_PRIORITY_UPDATE:-frozen}"
...
cmd=(
  ...
  +algorithm.slam_geometry_weight="$SLAM_GEOMETRY_WEIGHT"
  +algorithm.slam_visual_weight="$SLAM_VISUAL_WEIGHT"
  +algorithm.memory_priority_update="$MEMORY_PRIORITY_UPDATE"
...
echo "SLAM/KEEPSAKE geometry weight: $SLAM_GEOMETRY_WEIGHT"
echo "SLAM/KEEPSAKE visual weight: $SLAM_VISUAL_WEIGHT"
echo "Memory priority update: $MEMORY_PRIORITY_UPDATE"
